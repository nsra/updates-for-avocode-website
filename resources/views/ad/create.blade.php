                ...
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="en_button" value="{{old('en_button')}}">
                            <span class="error">{{$errors->first('en_button')}}</span>
                        </div>
                        <div class="form-group">
                            <label for="ar_button">{{__('lang.ar_button')}} <span class="required">*</span></label>
                            <input type="text" class="form-control" name="ar_button" value="{{old('ar_button')}}">
