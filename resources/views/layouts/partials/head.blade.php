...
<title>avocode company</title>
<link href="{{asset('/avocodetemplate/css/all.min.css')}}" rel="stylesheet">
@if(app()->getLocale() == 'ar')
    <link rel="stylesheet" href="{{asset('/avocodetemplate/css/bootstrap-rtl.min.css')}}">
@else
...
<link type="text/javascript" src="{{asset('/avocodetemplate/js/all.min.js')}}">
