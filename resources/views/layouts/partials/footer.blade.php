<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
            <div class="d-flex flex-nowrap">
                <img src="{{ asset('/control/assets/layouts/layout/img/toptech.jpg') }}" style="width: 125px"
                    class="mr-2" />
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3 ">
            ...
            <p>
                <i class="fas fa-map-marker-alt pl-3"></i> {{ $company->address }}
            </p>
            <p>
                <i class="fas fa-envelope pl-3"></i> {{ $company->email }}
            </p>
            <p>
                <i class="fab fa-whatsapp pl-3"></i>{{ $company->whatsapp }}
            </p>
        </div>
    ...
    <div class="row d-flex pb-3">
        ...
        <div class="col-md-7 col-lg-8">
            ...
            <p>{{ __($company->footer) }}<span class="pr-1"> {{ date('Y') }} Eng. Entesar K. ElBanna
                </span></p>
        </div>
