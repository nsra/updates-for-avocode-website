    ...
    <div class="row">
        ...
        <div class="col-md-11">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('order_steps.update', $order_step->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="en_title" value="{{ old('en_title', optional($order_step->translate('en'))->title) }}">
                            <span class="error">{{$errors->first('en_title')}}</span>
                        </div>
                        <div class="form-group">
                            <label for="ar_title">{{__('lang.ar_title')}} <span class="required">*</span></label>
                            <input type="text" class="form-control" name="ar_title" value="{{ old('ar_title', optional($order_step->translate('ar'))->title) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" name="en_description" >{{ old('en_description', optional($order_step->translate('en'))->description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" name="ar_description" >{{ old('ar_description', optional($order_step->translate('ar'))->description) }}</textarea>
                ...
                <div class="form-action text-center">
                    ...
                    <button href="{{route('order_steps.index')}}" type="reset"
